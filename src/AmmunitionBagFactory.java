 ...
 * @version 0.1
 */
public class AmmunitionBagFactory implements Runnable{
    ...
    public static void main(String[] args) {
        ...
        AmmunitionBagFactory ammunitionBagFactory = new AmmunitionBagFactory();
        ...
        Commons.executorService.execute(ammunitionBagFactory);
    }
}
